  ...
  return {
    ...
    module: {
      ...
      rules: [
         ...
         */
        {
          ...
          loaders: ['to-string-loader'].concat(ExtractTextPlugin.extract({ fallback: 'style-loader', use: 'css-loader'}))
        },
        ...
        {
          test: /\.css$/,
          include: [helpers.root('src', 'app'), helpers.root('UIKit')],
         ...
         */
        {
            ...
            loader:"file-loader?limit=8192&name=assets/img/[name].[ext]?[sha512:hash:base64:7]",
        }
      ]
    ...
    plugins: [
      ...
      new CopyWebpackPlugin([ {
          ...
          from: 'src/assets/css/bootstrap.min.css',
